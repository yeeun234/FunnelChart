...
import "./App.css"; // 제공하신 CSS를 여기에 저장했다고 가정
import logoImg from "./img/Logo.svg"; // 로고 이미지 경로에 맞게 수정
  ...
  return (
    <div className="appContainer">
      ...
      <main style={{ flex: 1, display: "flex", justifyContent: "center", alignItems: "center" }}>
        <section style={{ width: "100%",  maxWidth: 700, background: "#fff", padding: "60px 0" }}>
          <form style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0 20px" }}>
              <tbody>
                <tr>
                  <td style={{ width: 120, textAlign: "right", fontWeight: "bold" }}>이름</td>
                  <td>
                    <input type="text" style={{ width: "100%", padding: "10px", border: "1px solid #eee", borderRadius: 6 }} />
                  </td>
                </tr>
                <tr>
                  <td style={{ textAlign: "right", fontWeight: "bold" }}>아이디</td>
                ...
                <tr>
                  <td style={{ textAlign: "right", fontWeight: "bold" }}>비밀번호</td>
                  <td>
                ...
                <tr>
                  <td style={{ textAlign: "right", fontWeight: "bold" }}>비밀번호 확인</td>
                  <td>
                    <input type="password" style={{ width: "100%", padding: "10px", border: "1px solid #eee", borderRadius: 6 }} />
                  </td>
                </tr>
